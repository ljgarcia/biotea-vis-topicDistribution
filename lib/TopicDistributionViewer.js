    ...
    viewer.load = function() {
        _.each(viewer.options.ids, function(id) {
                ...
                loader.done(function(loadedData) {
                    var cards = viewer.svg.append('g').attr('transform', 'translate(' + viewer.margin.left + ', 0)')
                    ...
                    cards.attr('x', function(d) {
                        ...
                        .attr('class', function(d) {return 'biotea_score biotea_article_' + d.id;})
                        ...
                        .on('click', function(d) {
                            d3.selectAll('.biotea_score').style('stroke', 'white');
                            d3.selectAll('.biotea_article_' + d.id).style('stroke', 'black');
